...
public class CustomerService {
    public static void Run() {
        ...
        // Defect(s) Found: The ServeCustomer should get customer before deleting from the list

        Console.WriteLine("=================");

        // Test 2
        // Scenario: Add two customers and then serve the customers in order
        // Expected Result: Should display the customers in the same order that they were added
    ...
    private void ServeCustomer() {
        ...
        else
        {
            ...
            _queue.RemoveAt(0); // Defect 1 - Deleted should be done after
